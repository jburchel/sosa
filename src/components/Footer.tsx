...
export default function Footer() {
  return (
    <footer className="bg-sosa-dark border-t border-gray-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <div>
                <p className="font-bold text-lg">Square One Sports Academy</p>
                <p className="text-sosa-orange text-sm">More Than Basketball</p>
              </div>
            </div>
            <p className="text-gray-400 text-sm">
              A community-focused, faith-driven non-profit dedicated to developing
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-bold text-sm uppercase tracking-wider mb-4 text-sosa-orange">
              Quick Links
            </h3>
            <div className="grid grid-cols-2 gap-2">
              {NAV_LINKS.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-gray-400 text-sm hover:text-sosa-orange transition-colors"
                >
                  {link.label}
                </Link>
              ))}
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="text-gray-400 hover:text-sosa-orange transition-colors"
                aria-label="Facebook"
              >
