...
const PROGRAM_DETAILS = [
  {
    ...
    icon: '🏀',
    slotId: 'programs-travel',
    defaultAlt: 'Boys Tigers game action — dunk and layup',
  ...
  },
  {
    ...
    icon: '🎯',
    slotId: 'programs-training',
    defaultAlt: 'Players training in orange uniforms on indoor court',
  ...
  },
  {
    ...
    icon: '🌟',
    slotId: 'programs-mentorship',
    defaultAlt: 'Teen player in SOSA orange and black jersey',
  ...
  },
  {
    ...
    icon: '🤝',
    slotId: 'programs-community',
    defaultAlt: 'SOSA community event',
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4 space-y-10">
          {PROGRAM_DETAILS.map((program, index) => {
            const imgSrc = resolveSlotSrc(program.slotId, manifest);
            return (
              <div
                key={program.title}
